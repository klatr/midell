...
# ---- STEP 3: Spicetify + Marketplace ----
# Spicetify is a tool that lets you theme and mod Spotify.
# It can't be silently installed like a normal app - it needs to run as YOUR user
# (not as admin), and Marketplace needs a second command after the base install.
Write-Header "Step 3: Installing Spicetify + Marketplace"
...
Write-Host "  * Spicetify applies on next Spotify launch - open Spotify to confirm." -ForegroundColor Yellow
Write-Host "  * Windhawk mods are chosen in the Windhawk app after install." -ForegroundColor Yellow
