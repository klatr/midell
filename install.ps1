...
# ---- STEP 7: Download Wallpapers & qBittorrent Theme ----
Write-Header "Step 7: Downloading Wallpapers & qBittorrent Theme"
...
Invoke-WebRequest -Uri "$base/qbittorrent theme/fluent-dark.qbtheme" -OutFile "$qbDir\fluent-dark.qbtheme"
