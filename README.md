...
- **Nordzy cursor theme** — downloaded and applied automatically, no reboot needed
- **qBittorrent theme** — fluent-dark downloaded to `Documents\qBittorrent Theme`

---

## After It Finishes

The script prints two checklists at the end:

- **Windhawk mods** — install manually in the Windhawk app
- **Zen Mods** — install manually in Zen → Settings → Mods
- **Spinning CD Cover Art** — install from Spotify's Spicetify Marketplace

To apply the qBittorrent theme: `View → Theme File → select fluent-dark.qbtheme`
